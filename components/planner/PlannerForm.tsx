        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="bg-white rounded-2xl border border-neutral-100 p-5 shadow-sm space-y-3">
            ...
            <input
              ...
              placeholder={
                isHi
                  ? "उदा. प्रकाश संश्लेषण, भिन्न, सौरमंडल..."
                  : "e.g. Photosynthesis, Fractions, The Solar System..."
              }
          ...
          <div className="bg-white rounded-2xl border border-neutral-100 p-5 shadow-sm space-y-3">
            <label
              ...
              className="text-xs font-bold text-neutral-400 uppercase tracking-wider block"
            >
              {isHi ? "सीखने के उद्देश्य / संदर्भ (वैकल्पिक)" : "Learning Objectives / Context (Optional)"}
            </label>
            <textarea
              id="details"
              ...
              placeholder={
                isHi
                  ? "विशिष्ट लक्ष्य, छात्र आवश्यकताएं, या कक्षा संदर्भ..."
                  : "Specific goals, student needs, or classroom context..."
              }
              rows={4}
        ...
        >
          {loading ? (
            <>
              ...
              {t("core.planner.generating")}
            </>
          ) : (
            <>
              <Sparkles className="w-5 h-5" />
              {t("core.planner.generate")}
            </>
          )}
        </button>
      )}
